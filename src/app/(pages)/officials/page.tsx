            ...
            <div className="relative bg-zinc-950 pt-20 pb-14 px-4 overflow-hidden">
                ...
                <div className="max-w-5xl xl:max-w-7xl px-5 mx-auto relative z-10">
                    <div className="flex flex-col justify-between gap-6 mb-8">
                        {/* View Switcher */}
                        <div className="bg-white/10 w-fit backdrop-blur-md p-1 rounded-xl flex shrink-0 border border-white/10">
                            <button
                        ...
                        <div>
                            <h1 className="text-4xl md:text-6xl font-black text-white mb-3 tracking-tight">
                                {viewMode === 'directory' ? <><span className="text-green-500">Know Your </span>Officials</> : <><span className="text-green-500">Performance </span>Leaderboard</>}
                            </h1>
                            ...
                            <div className="flex gap-2 overflow-x-auto pb-0.5 md:pb-0 scrollbar-hide">
                                {["All", "Governor", "Senator", "Minister", "Director"].map((role) => (
                                    <button
                                        ...
                                        className={`px-4 cursor-pointer min-w-16 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${filter === role
                                            ? "bg-white text-black"
                                            : "bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                                            }`}
                                    >
                                        {role}
                                    </button>
                                            ...
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex items-start gap-4">
                                                    <div className="w-14 h-14 rounded-full bg-zinc-200 dark:bg-zinc-800 overflow-hidden shrink-0">
                                                        {
                                                            official.image ? (
                                                                <Image src={official.image} alt={official.name} width={56} height={56} className="w-full h-full object-cover" />
                                                            ) : (
