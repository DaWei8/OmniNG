...
export default function StatePage() {
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white font-sans">
            <div className="relative h-64 md:h-80 bg-zinc-950 pt-20 pb-14 px-4 overflow-hidden">
                ...
                <div className='max-w-7xl relative mx-auto'>
                    <div className="absolute top-12 inset-0 flex items-center justify-center flex-col">
