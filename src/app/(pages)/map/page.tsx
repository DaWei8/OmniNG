                        ...
                        <div id='category-buttons' className="flex gap-2">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={clsx(
                                        "px-4 py-2 rounded-lg text-sm cursor-pointer font-medium whitespace-nowrap transition-all",
                                        selectedMetric === cat
                                            ? "bg-white text-black shadow-lg"
                                            : "bg-zinc-100/30 dark:bg-zinc-800 text-black hover:text-zinc-800 hover:dark:text-zinc-100 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700"
                                    )}
                                >
                                    {cat}
                                </button>
